...
for thread in thread_sold:
  if not "&" in thread:
    ...
    for single in multi_thread:
      thread_sold_split.append(single)
...
color_statement = ""
for color in colors:
  new_statement = "{num_color} threads of {color} were sold today.\n".format(num_color = color_count(color), color=color)
  color_statement += new_statement
print(color_statement)